    ...
    <div class="container">
      ...
      <form method="POST" action="index.php" enctype="multipart/form-data">
        <div class="input-field fname">
          <span>FIRST NAME :</span> <input required type="text" name="fname"
        ...
        <div class="input-field lname">
          <span>LAST NAME :</span> <input required type="text" name="lname"
        ...
        <div class="input-field fullname">
          <span>FULL NAME :</span> <input type="text" name="fullname" placeholder="your full name"
            value="<?php echo isset($_POST['fullname']) ? ($obj->fname . " " . $obj->lname) : '' ?>" readonly>
        </div>
        ...
        <div class="input-field marks-table">
          ...
          <textarea required rows=10 name="marksTable"
            placeholder="enter your marks"><?php echo isset($_POST['marksTable']) ? $obj->marksTable : '' ?></textarea>
          <span class="error">
            <?php echo $obj->marksErr; ?>
          </span>
        </div>
        <div class="input-field phone">
          <span>PHONE NUMBER (Enter with your contry code) :</span> <input required type="text" name="phn"
            value="<?php echo isset($_POST['phn']) ? $obj->phn : '' ?>" placeholder="enter your phone number">
          <span class="error">
            <?php echo $obj->phnErr; ?>
          </span>
        </div>
        <div class="input-field mail">
          <span>E-MAIL ID :</span> <input required type="text" name="mail"
            value="<?php echo isset($_POST['mail']) ? $obj->mail : '' ?>" placeholder="enter your email id">
          <span class="error">
